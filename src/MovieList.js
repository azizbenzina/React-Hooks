      ...
      <div className="MovieList">
                <Filter list={movieList} SeFiltredList={SeFiltredList}/>
          {
              movieList.map((value,index)=>(
                <MovieCard title={value.title} description={value.description} posterUrl={value.posterUrl} date={value.date}genre={value.genre}duration={value.duration} rating={value.rating}/>
              ))
          }
